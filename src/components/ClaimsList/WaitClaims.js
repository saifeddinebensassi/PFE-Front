...
const WaitClaims = () => {
    ...
    useEffect(() => {
        ...
        HandlingService.getAllSemestre()
            .then(
                (result) =>
            ...
            <div className="homeContent">
                <div>
                    <div className="tabStudentsTitle">
                        <h2 className='hideC'>Liste des Semstres</h2>
                        <div>
                        </div>
                        {/* <div className='srch'>
                            ...
                            <table cellPadding="0" cellSpacing="0" border="0" className="studentsTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th className='thStd hideC' htmlFor="touch"  >NUM SEMESTRE </th>
                            ...
                            <table cellPadding="0" cellSpacing="0" border="0" className="studentsTable">
                                <tbody>
                                    {claims.map(claim => <tr key={claim.id}>
                                        ...
                                        <td className='thStd hideC'>
                                            {moment(claim.dateDebSemstre).format('L')}

                                        </td>
                                        <td className='thStd hideC'>
                                            {moment(claim.dateFinSemstre).format('L')}
                                        </td>
                                        <td className='thStd'>
                    ...
                    <button className="addService" onClick={() => setVisible2(true)}><i className="bi bi-plus"></i> Nouvelle Semestre</button>
